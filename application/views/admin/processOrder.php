                  ...
                  <tbody>
                    ...
                    ?>
                      <?php foreach ($results as $key) {
                        ...
                        if($status == "Confirm")
                        {
                          $styl = "style='background:#FFE1CD'";
                        }
                        else
                        {
                          $styl = "style='background:#E4FFCD'";
                        }
                       ?>
                        <tr <?= $styl; ?>>
                          <td><?= $key->date; ?></td>
                          ...
                          <td><?= $key->status; ?></td>
                          <td>
                            <a href="<?= base_url(); ?>Admin/DetailsOrder/<?= $key->order_id; ?>/processOrder">
                              <button class="btn btn-primary">Details</button>
                            </a>
                            <a href="<?= base_url(); ?>Admin/deleteOrder/<?= $key->id; ?>/processOrder" onClick="return confirm('Delete this Order? Once it Deleted never can retrive. Click Ok to process the Deletion');">
