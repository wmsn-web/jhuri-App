                  ...
                  <tbody>
                    ...
                    ?>
                      <?php foreach ($results as $key) { ?>
                        <tr style="background: #95D65E">
                          <td><?= $key->date; ?></td>
                          <td><?= $key->order_id; ?></td>
                          <td><?= $key->user_id; ?></td>
                          <td><?= $key->status; ?></td>
                          <td>
                            <a href="<?= base_url(); ?>Admin/DetailsOrder/<?= $key->order_id; ?>/completeOrder">
                              <button class="btn btn-primary">Details</button>
                            </a>
                            <a href="<?= base_url(); ?>Admin/deleteOrder/<?= $key->id; ?>/completeOrder" onClick="return confirm('Delete this Order? Once it Deleted never can retrive. Click Ok to process the Deletion');">
