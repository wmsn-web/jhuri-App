                    ...
                    ?>
                      <?php foreach ($results as $key) { ?>
                        <tr>
                          ...
                          <td><?= $key->status; ?></td>
                          <td>
                            <a href="<?= base_url(); ?>Admin/DetailsOrder/<?= $key->order_id; ?>/cancelOrder">
                              <button class="btn btn-primary">Details</button>
                            </a>
                            <a href="<?= base_url(); ?>Admin/deleteOrder/<?= $key->id; ?>/cancelOrder" onClick="return confirm('Delete this Order? Once it Deleted never can retrive. Click Ok to process the Deletion');">
