...
function MenuEditor(idSelector, options) {
    var $main = $("#" + idSelector);
    var settings = {
        labelEdit: '<i class="fa fa-pencil clickable"></i>',
        labelRemove: '<i class="fa fa-close clickable"></i>',
    ...
    function TButtonGroup() {
        ...
        var $btnOut = TButton({classCss: 'btn btn-default btn-xs btnOut btnMove', text: '<i class="fa fa-save clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-default btn-xs btnIn btnMove', text: '<i class="fas fa-file-export clickable"></i>'});
    ...
    this.update = function(){
        ...
        $cEl.find('span.txt').first().html($cEl.data('text')+"<span class='rght'>"+$cEl.data('title')+"</span>");
        resetForm();
    };
    ...
    this.add = function(){
        ...
        var textItem = $('<span>').addClass('txt').html(data.text +"<span class='rght'>"+ data.title+"</span>");
        var iconItem = $('<i>').addClass(data.icon);
        var div = $('<div>').append(iconItem).append("&nbsp;").append(textItem).append(btnGroup);
        var $li = $("<li>").data(data);
        $li.addClass('lstOrdinp').append(div);
        $main.append($li);
        MenuEditor.updateButtons($main);
        resetForm();
    };
